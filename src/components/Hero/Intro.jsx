            ...
            <div className="small-intro">
              <div className="intro-row">
                <div className="col-lg-5  col-md-6 col-sm-12 intro-left">
                  ...
                  >
                    <a
                      href={`${detail.hireMe_link}`}
                      className="contactMe"
                    >
                      <button className="contact-me">
                        Contact  <i className="bx bx-send "></i>
                      </button>
                    </a>
                  </div>
                  <div
                ...
                >
                  <div className="ff">
                    {/* <img
                      className="intro-img"
                      src="https://drive.google.com/uc?id=1QzylEvTHMGvKbGZ0CD9Ev9VT2E47GNqt"
                      alt=""
                    /> */}
                    <img
                      className="intro-img"
